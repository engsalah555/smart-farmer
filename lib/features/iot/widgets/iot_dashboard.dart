  ...
  Widget _buildFab(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: (isDark ? AppColors.darkAccent : const Color(0xFF0072FF))
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: value
                  ? [
                      BoxShadow(
                        color: activeColor2.withValues(alpha: 0.4),
                        blurRadius: 12,
    ...
    return Container(
      ...
      child: ListTile(
        ...
        leading: Container(
          ...
          child: Icon(
            isOn ? Icons.water_drop_rounded : Icons.opacity_rounded,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: gradientColors == null
            ? (isDark ? AppColors.darkCard : AppColors.getSurface(isDark))
            : null,
          ...
          BoxShadow(
            color:
                (gradientColors?.first ??
                        (isDark ? Colors.black : const Color(0xFFD0D0D0)))
